...
for site_name in $site_arr
 ...
 do
  ...
  envsubst '${BACKUP_SITE_NAME},${BACKUP_GDRIVE_PATH}' < /home/azureuser/LIFI/devops/ffg/backup-restore/docker-compose-backup-template.yml > /home/azureuser/LIFI/devops/ffg/backup-restore/docker-compose-backup.yml
  docker compose -f /home/azureuser/LIFI/devops/ffg/backup-restore/docker-compose-backup.yml up
